...
//! ## Features:
//!
//! 1. Automatic extension: When a lock is acquired, the lifetime of the lock will be automatically extended in background until the lock is released.
...
//! ```rust
//!
//! use async_redis_lock::{Locker, options::Options};
